...
Die formeln können nun noch für Komplexe Zahlen tauglich gemacht werden indem der Vektor $\vec{r}$ in kartesischen Koordinaten dargestellt wird und danach die Feldanteile Komplex geschrieben werden.
//TODO: nochmals darübergehen bezüglich der Schreibweise und der Herleitung.
...
\end{equation}
wird nun das Feld Komplex geschrieben
\begin{equation}
    \mathcal{E}(z)
    =
    \frac{\rho}{2\pi\varepsilon_0}
...
Für das Potential kann ein ähnliche Umformung vorgenommen werden und es ergibt sich analog zum $E$-Feld 
\begin{equation}
    \varphi(z) = 
    - \frac{\rho}{2\pi\varepsilon_0} \operatorname{ln}|z|
\end{equation}
